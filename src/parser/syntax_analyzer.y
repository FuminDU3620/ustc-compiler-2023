...
%token <node> ERROR
%token <node> SPECELSE SPECIF SPECINT SPECRETURN SPECVOID SPECWHILE SPECFLOAT ADD SUB MUL DIV LE GE LESS GREAT EQUAL NEQUAL ASSIGN SEMICOLON COMMA LPAREN RPAREN LSQUARE RSQUARE LCURLY RCURLY KEYWORD ID INTEGER FLOAT 
...
| type-specifier ID LSQUARE INTEGER RSQUARE SEMICOLON
{
...
| type-specifier ID LSQUARE RSQUARE
{
...
| SEMICOLON
{
    $$ = node("expression-stmt", 1, $1);
        ...
        ;
selection-stmt
: SPECIF LPAREN expression RPAREN statement
{
    $$ = node("selection-stmt", 5, $1, $2, $3, $4, $5);
}
| SPECIF LPAREN expression RPAREN statement SPECELSE statement
{
    $$ = node("selection-stmt", 7, $1, $2, $3, $4, $5, $6, $7);
}
        ;
iteration-stmt
: SPECWHILE LPAREN expression RPAREN statement
{
    $$ = node("iteration-stmt", 5, $1, $2, $3, $4, $5);
}
        ;
return-stmt
: SPECRETURN SEMICOLON
{
    $$ = node("return-stmt", 2, $1, $2);
}
| SPECRETURN expression SEMICOLON
{
